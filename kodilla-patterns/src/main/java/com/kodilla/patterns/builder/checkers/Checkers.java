...
public class Checkers {
    ...
    public static class CheckersBuilder {
        ...
        public CheckersBuilder Figure(String figureType, String figureColour, int x, int y) {
            ...
            if (board.getFigure(x, y) == null) {
                board.setFigure(FigureFactory.makeFigure(figureType, figureColour), x, y);
            } else {
        ...
        public Checkers build() {
            ...
            for(int x = Board.MIN_INDEX; x <= Board.MAX_INDEX; x++) {
                for(int y = Board.MIN_INDEX; y <= Board.MAX_INDEX; y++) {
                    ...
                    if (figure != null) {
                        if (figure.getColour().equals(Figure.BLACK)) {
                            black = true;
                        } else {
                            white = true;
                        }
