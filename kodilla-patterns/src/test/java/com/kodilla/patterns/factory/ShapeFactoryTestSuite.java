...
public class ShapeFactoryTestSuite {
    ...
    public void testFactorySquare() {
        ...
        ShapeFactory factory = new ShapeFactory();
        //When
        Shape sqare = factory.makeShape(ShapeFactory.SQUARE);
        //Then
        Assert.assertEquals(28.0, sqare.getCircumference(), 0);
        Assert.assertEquals("The angular square", sqare.getName());;
    }
